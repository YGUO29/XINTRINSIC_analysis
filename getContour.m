...
% para.zindex = (para.tone_gap + para.num_per_oct*para.tone_dur: para.num_per_oct*para.tone_dur: para.durStim - para.tone_gap)./...
...
hold all,
[C,c] = contour(M.hue, para.zindex, 'LineStyle','-.'); 
axis image; c.LineWidth = 2;     
colormap(hsv), 
% caxis([para.tone_gap para.durStim - para.tone_gap]./para.durStim)
