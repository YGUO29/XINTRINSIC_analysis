...
for k = 1:K
    subplot(1,K,k)
    R1 = Decomp_102D.Rs{iK}(2:2:end,k); % original voc
    R2 = Decomp_102D.Rs{iK}(1:2:end,k);
    scatter(R1(73:end),R2(73:end), 'MarkerFaceColor',[0.5 0.5 0.5],  'MarkerEdgeColor',[0.5 0.5 0.5]), hold on
    scatter(R1(1:36),R2(1:36), 'MarkerFaceColor','b', 'MarkerEdgeColor','b'), hold on
    scatter(R1(37:72),R2(37:72), 'MarkerFaceColor','c', 'MarkerEdgeColor','c'), hold on
%     scatter(R1(1:end-35),R2(1:end-35), 'MarkerFaceColor',[0.5 0.5 0.5],  'MarkerEdgeColor',[0.5 0.5 0.5]), hold on
%     scatter(R1(end-35:end),R2(end-35:end), 'MarkerFaceColor','r', 'MarkerEdgeColor','r'), hold on
