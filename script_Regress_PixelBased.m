...
% ============== get tonotopy ==================
para = getTonotopyParameters(para, '102D');
T = getTonotopy(X, para);

% register if necessary
% T = getRegisteredTonotopy(T, para, '80Z','auto'); 
...
plotRegressCorr(output, F, T, para, '102D');

%% plot component contours with R maps
ct = getContour_compmponent(Decomp_102D.Ws{1}, Decomp_102D.comp{1});
para.ct = ct(4);
plotRegressRsquared(output, F, para)
